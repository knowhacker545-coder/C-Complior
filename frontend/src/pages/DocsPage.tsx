...
const sections: DocSection[] = [
  { id: 'introduction', title: 'Introduction', text: 'C is a compiled programming language used for systems, embedded software, operating systems, and learning core programming concepts. CForge lets you read examples, edit them, and send them to the real CForge compiler when the compiler service is available.' },
  ...
  { id: 'file-handling', title: 'File Handling', text: 'C can work with files using FILE pointers and functions such as fopen, fprintf, fgets, and fclose. In CForge, filesystem access is restricted by the execution sandbox.', code: '#include <stdio.h>\n\nint main(void) {\n    FILE *file = fopen("notes.txt", "w");\n    if (!file) return 1;\n    fprintf(file, "Hello\\n");\n    fclose(file);\n    return 0;\n}' },
