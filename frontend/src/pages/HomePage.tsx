...
export default function HomePage() {
  ...
  const applyCompilerMarkers = useCallback((message: string) => {
    ...
    monaco.editor.setModelMarkers(editor.getModel(), 'cforge', markers);
  }, []);
